...
export const CategoriesPage = ({ initialCategories }: { initialCategories: Category[] }) => {
        ...
        return (
                <PageContainer title="Categories">
                        {categories.length > 0 ?
                                <div className="bg-white rounded w-full p-4 sm:p-6 h-full flex flex-col border border-gray-300">
                                        <div className="flex justify-between flex-col items-start sm:flex-row mb-4 sm:items-center gap-4">
                                                <p className="text-gray-800 text-2xl"><span className="font-bold">{categories.length}</span> Total Categories</p>
                                        ...
                                        <div className="overflow-auto flex-1">
                                                <table className="table-auto w-full text-left min-w-[768px] text-gray-950">
                                                        <thead>
                                                                <tr className="border-b-1 border-gray-300 font-bold text-gray-950 sticky top-0 p-2 z-3">

                                                                        <th className="p-2">
                                                                                <button type="button" className="inline-flex gap-2 items-center cursor-pointer" onClick={() => handleSortCategoriesByType("id")}>
                                                                                        Id
                                                                        ...
                                                                        <th className="p-2">
                                                                                <button type="button" className="inline-flex gap-2 items-center cursor-pointer" onClick={() => handleSortCategoriesByType("name")}>
                                                                                        Name
                                                                        ...
                                                                        <th className="p-2">
                                                                                <button type="button" className="inline-flex gap-2 items-center cursor-pointer" onClick={() => handleSortCategoriesByType("description")}>
                                                                                        Description
                                                                        ...
                                                                        <th className="p-2">
                                                                                <button type="button" className="inline-flex gap-2 items-center cursor-pointer" onClick={() => handleSortCategoriesByType("dateAdded")}>
                                                                                        Date Added
                                                                        ...
                                                                        <th className="p-2">
                                                                                <button type="button" className="inline-flex gap-2 items-center cursor-pointer" onClick={() => handleSortCategoriesByType("lastUpdated")}>
                                                                                        Last Updated
                                                                                ...
                                                                                <td className="relative px-2 py-3">
                                                                                        {dropdown?.id === category._id ?
                                                                                                <div className="relative" ref={dropdownRef}>
                                                                                                        ...
                                                                                                        <div className="flex flex-col absolute border rounded border-gray-400 bg-white z-50 right-full top-0">
                                                                                                                <button type="button" className="text-left cursor-pointer hover:bg-gray-200 py-2 px-4" onClick={() => { setModal({ type: 2 }); setSelectedCategory(category); handleCloseDropdown?.apply(handleCloseDropdown); }}>Edit</button>
                                                                                                                <button type="button" className="text-left cursor-pointer hover:bg-gray-200 py-2 px-4" onClick={() => { setModal({ type: 3 }); setSelectedCategory(category); handleCloseDropdown?.apply(handleCloseDropdown); }}>Delete</button>
                                                                                                        </div>
                                                                                                </div>
                                                                                                :
                                                                                                <button className="flex cursor-pointer hover:bg-gray-300 rounded transition p-1" onClick={() => handleShowDropdown && handleShowDropdown(category._id as string)}>
